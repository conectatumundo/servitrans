...
<div class="site-index">
    ...
    <div class="intro" style="background: url(<?= Yii::getAlias('@web') ?>/images/uploads/keyvisual.png" ?>) ">
        <div class="wrap">
            <div class="textwidget">
                ...
                <h2 class="wow fadeInUp">Calidad y Cumplimiento.</h2>
                <!--
                <div class="actions">
   ...
   //Testimonials -->
    ...
    <div class="color cta">
        <div class="wrap">
            <p class="wow fadeInLeft">Conoce sobre nosotros.</p>
            <?= Html::a('Ir',['site/nosotros'],['class' => 'btn huge black right wow fadeInRight']) ?>
        </div>
    </div>
    <!-- //Call to action -->
</div>
